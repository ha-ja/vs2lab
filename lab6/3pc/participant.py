...
from const2PC import PREPARE_COMMIT, VOTE_REQUEST, GLOBAL_COMMIT, GLOBAL_ABORT
# participant decissions
from const2PC import LOCAL_SUCCESS, LOCAL_ABORT
# participant messages
from const2PC import READY_COMMIT, VOTE_COMMIT, VOTE_ABORT, NEED_DECISION
# misc constants
            ...
            # we are ready to proceed the joint commit
                ...
                if not msg:  # Crashed coordinator
                    ...
                    while True:
                        ...
                        if msg[1] in [
                                PREPARE_COMMIT, GLOBAL_COMMIT, GLOBAL_ABORT, LOCAL_ABORT]:
                            decision = msg[1]
                            break
